    ...
    <div className="bg-slate-950 py-24 min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          ...
          <button className="flex items-center gap-2 text-xs font-bold text-white uppercase tracking-widest bg-slate-900 border border-slate-800 px-6 py-3 rounded-sm hover:bg-slate-800 transition-all">
          ...
          {categories.map((category) => (
            <div key={category}>
              ...
              <div className="space-y-1">
                {PRICES.filter(p => p.category === category).map((item, idx) => (
        ...
        <div className="mt-16 text-center">
          ...
          <a href="#contacts" className="inline-block bg-white text-slate-950 px-10 py-4 font-bold uppercase tracking-widest text-xs hover:bg-amber-600 hover:text-white transition-all">
